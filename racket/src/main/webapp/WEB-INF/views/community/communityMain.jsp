    ...
    <div id=wrap>
        ...
        <nav>
            ...
            <div class="search-area">
                ...
                <div class="view_controller">
	                <button onclick="BorderCreate()"
	                    style="margin-left: auto; margin-right: 5px; background-image: url('/prac/resources/images/글쓰기.png'); background-position: center; background-size: 100% 100%;"></button>
        ...
        <section>
            ...
            <article id="art-1">           
           		  ...
           		  <div class="review_wrap">     
					 	 ...
					 	 <a href="/prac/DetailReview">
	                        <div class="post">             
	                        
	                            <div>
	                                <img class ="image" src="/prac/resources/images/${item.image}"> 
	                            </div>
	                            <div>
	                                <div class="content"> ${item.content} </div>
	                                <p class="meta">작성자: ${item.writer}   | 작성일: ${item.days} </p>
	                            </div>
	                        </div>  
	                        </a>
	                        </c:forEach>                    
