...
<body>
<div> ${post.board_name}</div>
    <!-- 글 제목 부분-->
    <div class="container">
        <div class="category"><a href="#" style="font-size: 2rem; font-weight: bold; color: rgb(0, 0, 0);">후기 게시판</a>
        </div>
        <div class="title_container">
            <div class="title">
                <h2 style="font-size: 2.5rem; font-weight: bold;">글 제목</h2>
            </div>
            <div class="data">
                <div class="user_id">
                    <h6>아이디ddddddddddddd</h6>
                </div>
                <div class="date" style="margin-left: 10px;">
                    <h6>2024-05-07 16:33:00</h6>
                </div>
                <div class="data_board">
                    <div class="1">조회 1123</div>
                    <div class="2">추천 23</div>
        ...
        <!-- 글 내용 부분 -->
        <div class="content">
            <div class="realcontent" style="padding: 0 10px;">게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글
                본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글
                본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글
                본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글
                본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글
                본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글
                본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문
                게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문
                게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문
                게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문
                게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문
                게시글 본문 게시글 본문게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문 게시글 본문</div>
        </div>
        <div class="report_container">
            <!-- 추천 , 비추천 -->
            <div class="inner">
                <div>
                    <p style="margin-top: 5px; color: #d31900;">87</p>
                    <button onclick=""
